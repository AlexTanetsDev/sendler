  ...
  return (
    <div className="w-[300px] h-[200px]	xl:w-[1200px] 	xl:h-[1000px] lg:w-[1000px] lg:h-[800px] md:w-[700px] md:h-[500px] overflow-auto  bg-white p-12  text-xl flex  flex-col text-justify">
      ...
      <p className=" mt-8 ">
        ...
        України, пропонують необмеженому колу фізичних осіб, укласти цей Договір (далі - Договір) на
        нижчевикладених умовах:
      </p>
      ...
      <p>
        ...
        - ім&apos;я Відправника (не більше 11 символів - кількість знаків обмежена протоколом GSM),
        яке складається з латинських букв та / або цифр, що присвоюється Замовником при відправці
        SMS- повідомлень.
      </p>
      <p>
        <span className="pl-10 ">
      ...
      <p>
        <span className="pl-10 ">
          1.10. <span className=" font-semibold"> SME (Short Message Entry)</span>
        </span>{' '}
      ...
      <p>
        <span className="pl-10 ">
          1.11. <span className=" font-semibold">WEB-інтерфейс</span> 
        </span>{' '}
      ...
      <p>
        <span className="pl-10 ">
          1.12. <span className=" font-semibold">Трафік</span> 
        </span>{' '}
        - кількість вхідних і вихідних SMS-повідомлень за Звітний період дії цього Договору.
      </p>
      <p>
        <span className="pl-10 ">
          1.13. <span className=" font-semibold">Звітний період</span> 
        </span>{' '}
        - календарний місяць, протягом якого Замовнику надавались послуги за цим Договором.
      </p>
      <p>
        <span className="pl-10 ">
          1.14. <span className=" font-semibold">Номер телефонної лінії сервісного
          обслуговування</span> 
        </span>{' '}
        – номер телефону Замовника або представника від Замовника, що забезпечує сервісну підтримку
        Користувачів щодо розсилки SMS-повідомлень в рамках цього Договору, зокрема: консультування,
        прийняття скарг, надання згоди чи/та заборони на отримання SMS- повідомлень від Замовника та
        ін.
      </p>
      <p>
        <span className="pl-10 ">
          1.15. <span className=" font-semibold">Електронний рахунок</span> 
        </span>{' '}
      ...
      <p>
        <span className="pl-10 ">
          1.16. <span className=" font-semibold">Мінусовій рахунок</span> 
        </span>{' '}
        ...
        WEB-інтерфейсі визнається безумовним грошовим зобов&apos;язанням Замовника перед Виконавцем
        (кредиторською заборгованістю Замовника).
      </p>
      <p>
        <span className="pl-10 ">
          1.17. <span className=" font-semibold">Контактний e-mail</span>
        </span>{' '}
        - це електронна адреса, що вказується Замовником в особистому кабінеті, та використовується
        для отримання Замовником інформаційних та рекламних повідомлень від адміністрації сайту.
      </p>
      <p>
        <span className="pl-10 ">
          1.18. <span className=" font-semibold">Сайт</span> 
        </span>{' '}
      ...
      <p>
        {' '}
        <span className="pl-10 ">
          1.19. <span className=" font-semibold">СПАМ-повідомлення</span> 
        </span>{' '}
        - це:
       <ul className='pl-24'>
       <li>
      ...
      <li>
        • SMS-повідомлення, текст яких не був попередньо погоджений з Виконавцем, у разі, якщо таке
        узгодження тексту Виконавцем є обов&apos;язковим згідно умов цього Договору;
      </li>
      <li>
      ...
      <li>• SMS-повідомлення яке містить інформацію релігійного характеру.</li>
       </ul>
      </p>
      ...
      <p>
        2.2. Фактом надання Послуги за цим Договором є проходження SMS-повідомлення, сформованого і
        відправленого Замовником, через систему Виконавця.
      </p>
      <h2 className="my-4 font-semibold text-xl text-center">3. Права та обов&apos;язки Замовника</h2>
      <p >
        <span className=' underline'>3.1. Замовник зобов&apos;язується:</span>
        <p>
        ...
        <p>
          ...
          згоду на отримання SMS-повідомлень від Замовника. Замовник протягом 2 (двох) робочих днів
          з моменту отримання відповідного запиту від Виконавця повинен надати письмове
        ...
        <p>
          ...
          щодо отриманих SMS-повідомлень, відповідальність за такі скарги / претензії / позови несе
          Замовник.
        </p>
        <p>
        ...
        <p>
          ...
          зв&apos;язку з наданням Користувачу /-ам в SMS-повідомленнях недостовірної, конфіденційної
          інформації, інформацію, яка була отримана Замовником на незаконних підставах або
          інформації, яка порушує права третіх осіб, або поширення якої заборонено чинним
          законодавством, Виконавець буде визнаний не належним відповідачем. Належним відповідачем у
          цьому випадку повинен бути визнаний Замовник. Замовник несе відповідальність згідно
        ...
        <p>
          3.1.10. Надсилати SMS-повідомлення лише у період з 09:00 до 20:00 у робочі дні та з 11:00
          до 18:00 у неробочі та святкові дні (дане обмеження не застосовується при відправленні
          повідомлень про підтвердження банківських операцій, реєстрацію на сайті, повідомлень від
          служб таксі та інші цілодобові сервісні повідомлення, попередньо погоджені Замовником з
          Виконавцем.)
        </p>
      </p>
      <p>
      <span className=' underline'> 3.2. Замовник не має права:</span>
        <p>
          3.2.1. Реєструвати ім&apos;я відправника, яке може вплинути на репутацію сторонніх осіб і
          організацій. Наприклад, назва компанії, до якої Замовник не має ніякого відношення, або
          номер телефону, який не належить Замовнику.
        </p>
        <p>
      ...
      <h2 className="my-4 font-semibold text-xl text-center">4. Права та обов&apos;язки Виконавця</h2>
      <p>
      <span className=' underline'>4.1. Виконавець зобов&apos;язується:</span> 
        <p>
        ...
        <p>
          ...
          винятком випадків виникнення проблем з електроживленням, пожежею, терористичним актом, та
          іншими обставинами непереборної сили, які підтверджуються відповідною довідкою
        ...
        <p>
          4.1.5. Вести облік наданих послуг за підсумками кожного звітного періоду і відображати ці
          дані на сторінці статистики WEB- інтерфейсу.
        </p>
        <p>
      ...
      <p>
      <span className=' underline'> 4.2. Виконавець має право:</span>
        <p>
          ...
          сайті. Час проведення профілактичних робіт має становити не більше 5 (п&apos;яти) годин за
          раз.
        </p>
        <p>
          ...
          визнається згодою Замовника на зміну тарифів. Припинення користування Замовником послугами
          за цим Договором з моменту вступу в силу нових тарифів визнається відмовою Замовника від
          змінених тарифів, після чого Виконавець має право вважати Договір припиненим.
        </p>
        <p>
      ...
      <p>
        ...
        перерахування грошових коштів на розрахунковий рахунок Виконавця, Виконавець поповнює СМС у
        власний кабінет Замовника після зарахування грошових коштів на розрахунковий рахунок
        Виконавця.
      </p>
      ...
      <p>
        6.1. Сторони несуть відповідальність за невиконання або неналежне виконання зобов&apos;язань
        за цим Договором відповідно до чинного законодавства України.
      </p>
      <p>
        ...
        збитки, понесені Замовником у зв&apos;язку із втратою пароля, або доступністю пароля третім
        особам.
      </p>
      <p>
      ...
      <p>
        6.5. Відповідальність за зміст відправлених Замовником SMS-повідомлень несе сам Замовник. В
        рамках цього Договору Виконавець забезпечує проходження SMS-повідомлень в їх незмінному
        змісті та обсязі, без будь- якого тлумачення, редагування або цензурування, в зв&apos;язку з
        цим відповідальність за включення до SMS- повідомлення відомостей і даних, що суперечать
      ...
      <p>
        ...
        встановленого порядку використання Мобільних номерів (у тому числі Номери відправника), несе
        Замовник.
      </p>
      <p>
        ...
        його умов, претензій чи вимог виплати компенсацій на користь Операторів, а також Абонентів,
        транзитних мереж, провайдерів і будь-яких інших третіх осіб, що мали відношення до прийому,
        обробки та передачі SMS-повідомлень, переданих через SMSC Виконавця від Замовника. Положення
        цього пункту діє також щодо власників авторського права і будь- яких організацій і приватних
        осіб, чиї права могли бути порушені в результаті передачі SMS-повідомлень, переданих через
        SMSC Виконавця від Замовника. Про вказані у цьому пункті претензії та вимоги Виконавець
        зобов’язаний повідомляти Замовника протягом 1 (одного) робочого дня з моменту їх отримання.
      </p>
      <p>
      ...
      <p>
        7.1. Виконавець залишає за собою право без попереднього повідомлення Замовника вносити зміни
        в тарифну політику з подальшою публікацією нових тарифів на Сайті. Такі зміни набувають
        чинності після закінчення 5 (п&apos;яти) робочих днів з моменту розміщення нових тарифів на
        Сайті. При незгоді Замовника із внесеними змінами він зобов&apos;язаний відмовитися від
        доступу до Сайту, припинити використання матеріалів і сервісів Сайту.
      </p>
      <p>
