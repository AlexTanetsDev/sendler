...
const OfferContract = (props: Props) => {
  return (
    <div className="w-[1200px] h-[1000px] overflow-auto  bg-white p-12  text-xl flex  flex-col text-justify">
      ...
      <h2 className="my-4 font-semibold text-xl text-center text-center">1. Визначення термінів</h2>
